...
function init(settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: "/./_app/start-63afca08.js",
      css: ["/./_app/assets/start-a8cd1609.css"],
      js: ["/./_app/start-63afca08.js", "/./_app/chunks/vendor-b7e99b21.js"]
    },
    fetched: void 0,
    floc: false,
...
var metadata_lookup = { ".svelte-kit/build/components/layout.svelte": { "entry": "/./_app/layout.svelte-a8ec4a83.js", "css": [], "js": ["/./_app/layout.svelte-a8ec4a83.js", "/./_app/chunks/vendor-b7e99b21.js"], "styles": null }, ".svelte-kit/build/components/error.svelte": { "entry": "/./_app/error.svelte-74f7b6d4.js", "css": [], "js": ["/./_app/error.svelte-74f7b6d4.js", "/./_app/chunks/vendor-b7e99b21.js"], "styles": null }, "src/routes/index.svelte": { "entry": "/./_app/pages/index.svelte-b4c36f86.js", "css": [], "js": ["/./_app/pages/index.svelte-b4c36f86.js", "/./_app/chunks/vendor-b7e99b21.js"], "styles": null } };
...
var Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  onMount(() => {
    ...
    webSocket.onmessage = function(ev) {
      const post = JSON.parse(ev.data);
      if (post.type === "message") {
        const newMessage = post.data;
        messages = [...messages, newMessage];
      } else if (post.type === "update") {
        const newUsername = post.data;
...
${each(messages, ({ from, text, to }) => `<p>${escape2(from)}: ${escape2(text)}</p>`)}
<p>UUID: ${escape2(username.uuid)}</p>
<form><label>Username
		<input type="${"text"}"${add_attribute("value", newName, 1)}></label>
	<button type="${"submit"}">Update Username</button></form>
<br>
${username.name ? `<form><label>Message
			<input type="${"text"}"${add_attribute("value", message.text, 1)}></label>
